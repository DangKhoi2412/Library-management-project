...
{
    public partial class fChiTietBaoCao : Form
    {
        private readonly BaoCaoViewModel _chiTietPhieu;
        private readonly Book book;
        private readonly Reader reader;
        public fChiTietBaoCao(BaoCaoViewModel chiTietPhieu)
        {
            InitializeComponent();
        ...
        private void fChiTietBaoCao_Load(object sender, EventArgs e)
        {
